                ...
                <div class="col-sm-9 list">
                        ...
                        <form name ='form_pengguna' action='<?php echo $_SERVER['PHP_SELF'];?>' method = 'post'>
                            <div class="form-group">
                                ...
                                <div class="form-inline">
                                    <input id="namauser2" class="span1 form-control" type = 'text' name = 'namauser2' placeholder = 'Nama Pengguna'/>
                 ...
                 <div class="col-sm-3">
                    ...
                    <form name ='form_tambah_pengguna' action='controller/pengguna.php' method = 'post'>
                        ...
                        <input id="iduser" class="span4 form-control" type = 'text' name = 'iduser' placeholder = 'ID Pengguna'/>
                        <h4>Nama Pengguna</h4>
                        <super>Nama pengguna/nama institusi</super>
                        <input id="namauser" class="span4 form-control" type = 'text' name = 'namauser' placeholder = 'Nama Pengguna'/>
